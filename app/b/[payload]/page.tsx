...
function ErrorState() {
  return (
    <div className="mx-auto flex min-h-screen w-full max-w-3xl items-center px-5 py-16 sm:px-8">
      <div className="w-full rounded-3xl border border-rose-100 bg-white/90 p-8 text-center shadow-soft sm:p-10">
...
export default async function BouquetViewPage({ params }: BouquetViewPageProps) {
  ...
  return (
    <div className="mx-auto flex min-h-screen w-full max-w-3xl items-center px-5 py-16 sm:px-8">
      <article className="w-full rounded-2xl border border-rose-100 bg-white p-5 shadow-sm sm:p-6">
        <section className="space-y-4 min-h-[32rem]">
          ...
          <div className="mx-auto w-full max-w-[39rem]">
            <p className="handwriting whitespace-pre-wrap break-words px-1 py-2 text-3xl leading-tight text-rose-700">
