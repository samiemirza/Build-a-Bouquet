  ...
  const renderCard = (item: BouquetOption) => {
    ...
    return (
      <button
        ...
        } ${horizontal ? "min-w-[10.5rem] shrink-0 snap-start sm:min-w-[12.5rem]" : "hover:-translate-y-0.5"}`}
      >
  ...
  return (
    <div className="relative">
      <button
        ...
        className="absolute -left-4 top-1/2 z-10 hidden -translate-y-1/2 px-1 text-6xl leading-none text-slate-400 transition hover:text-slate-700 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-rose-300 sm:-left-6 sm:block"
      >
        {"\u2039"}
      </button>
      ...
      <button
        ...
        className="absolute -right-4 top-1/2 z-10 hidden -translate-y-1/2 px-1 text-6xl leading-none text-slate-400 transition hover:text-slate-700 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-rose-300 sm:-right-6 sm:block"
      >
        {"\u203a"}
      </button>
    </div>
